...
const promiseCards = [
  ...
  {
    title: "教員が、学びの過程を確認",
    body: "学生が翌日に何を見ようとしたか、どこで支援が必要だったかを、教員が確認しやすい材料として整理します。",
    icon: "memo",
  },
];
...
const governanceItems = [
  ...
  "実習先で受けた指導の受け止めと、翌日の観察への変化を教員確認や授業共有で扱いやすくする",
];
...
const positioningCards = [
  ...
  },
  {
    ...
    body: "学生の観察メモ、実習先指導の受け止め、自己確認、教員が指導で確認するポイントを一つの学習プロセスとして扱います。",
  },
];
