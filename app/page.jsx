...
const promiseCards = [
  ...
  {
    title: "実習後面談で、学びの過程を確認",
    body: "全件添削を増やすのではなく、学生が翌日に何を見ようとしたか、どこで支援が必要だったかを面談材料として整理します。",
    icon: "memo",
  },
];
...
const feedbackLoopSteps = [
  ...
  },
  {
    label: "04",
    title: "実習後面談につなげる",
    body: "教員は全件を読むのではなく、学生が何を受け止め、どう改善しようとしたかを面談材料として確認できます。",
  },
];
...
const caseSteps = [
  ...
  },
  {
    ...
    body: "実習日誌フォーマット、確認観点、面談サマリーの見え方を、学校の実運用に合わせて確認します。",
  },
  {
    label: "導入 03",
      ...
      <section className="manalio-section manalio-feedback" id="loop">
        <div className="manalio-section-head center">
          ...
          <p>
            ...
            学生が受け止めた指導を、自分の言葉で整理し、翌日の行動と実習後面談につなげることです。
          </p>
        </div>
